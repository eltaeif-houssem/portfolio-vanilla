...
learnMoreBtns.forEach((learnMoreBtn, idx) => {
  learnMoreBtn.addEventListener("click", () => {
    modal(idx);
  });
});

modalCloseBtns.forEach((modalCloseBtn, idx) => {
...
imgCards.forEach((imgCard, idx) => {
  imgCard.addEventListener("click", () => {
    portfolioModal(idx);
  });
});

portfolioCloseBtns.forEach((portfolioCloseBtn, idx) => {
...
if (savedTheme) {
  ...
  themeBtn.classList[savedIcon === "sun" ? "remove" : "add"]("sun");
}
...
//Target elements, and specify options to create reveal animaions
